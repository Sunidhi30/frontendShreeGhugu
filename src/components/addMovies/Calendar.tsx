...
// Interface for API response structures// Update these interfaces to match your API response structure
  ...
  useEffect(() => {
    const fetchData = async (): Promise<void> => {
      try {
        ...
        setChannels(channelsRes.data.channels || []); // Make sure to handle the response structure
