...
const [trailerType, setTrailerType] = useState('external'); // 'external' or 'upload'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (trailerType === 'external') {
      formData.append('trailer_url', form.trailer_url); // Use the external URL
    } else if (trailer) {
      formData.append('trailer_url', trailer); // Upload the file
    }
...
<div className="space-y-4">
  ...
  <div className="flex items-center space-x-4">
    <select
      ...
      className="px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
    >
  ...
  {trailerType === 'external' ? (
    ...
    <div className="border-2 border-dashed rounded-lg p-4 text-center">
      ...
      <input 
  type="file" 
  name="trailer_url"  // ✅ this matches backend expectation
  accept="video/*"
  onChange={(e) => {
