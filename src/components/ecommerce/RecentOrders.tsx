...
const RecentOrders: React.FC = () => {
  ...
  const handleViewAllVideos = () => {
    // Navigate to videos page - you can replace this with your routing logic
    window.location.href = '/basic-videos'; // or use router.push('/videos') if using Next.js router
  };

  // Show only first 5 videos
  const displayedVideos = videos.slice(0, 2);
  const hasMoreVideos = videos.length > 2;
