...
//     profileImage: "https://res.cloudinary.com/dlszwlh2k/image/upload/v1744623781/admin_profiles/oqwu5s7aasfmu7qidgkc.jpg",
//     email: "sunidhiratra21@gmail.com", // <-- Add email
//   });
...
//           <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
//             {/* <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800">
//               <Image width={80} height={80} src={user.profileImage} alt="user" />
//             </div> */}
//             <div className="order-3 xl:order-2">
//               {/* <h4 className="mb-2 text-lg font-semibold text-center text-gray-800 dark:text-white/90 xl:text-left">
//                 {user.name}
