...
//     releaseDate: '',
//     trailer_url: '',
//     trailerType: 'external' // 'external' or 'upload'
//   }]);
  
//   const [trailerFiles, setTrailerFiles] = useState<{ [key: number]: File }>({});
...
//     if (e.target.name === 'trailerFile') {
//       const files = (e.target as HTMLInputElement).files;
//       if (files && files[0]) {
//         setTrailerFiles(prev => ({
//           ...prev,
//           [index]: files[0]
//         }));
//       }
...
//     // Also remove any associated trailer file
//     const updatedTrailerFiles = { ...trailerFiles };
//     delete updatedTrailerFiles[index];
//     setTrailerFiles(updatedTrailerFiles);
//   };
...
//         formData.append('seasonNumber', String(i + 1));
//         formData.append('title', season.title);
//         formData.append('description', season.description);
//         formData.append('releaseDate', season.releaseDate);
        
//         // Handle trailer based on type
//         if (season.trailerType === 'external') {
//           formData.append('trailer_url', season.trailer_url);
//         } else if (trailerFiles[i]) {
//           formData.append('trailer_url', trailerFiles[i]);
//         }
...
//                       <select
//                         name="trailerType"
//                         value={season.trailerType}
//                         onChange={(e) => handleChange(index, e)}
//                         className="w-full px-3 py-2 rounded border dark:bg-gray-600 dark:text-white mb-2"
//                       >
//                         <option value="external">External URL</option>
//                         <option value="upload">Upload Video</option>
//                       </select>

//                       {season.trailerType === 'external' ? (
//                         <input
//                           type="url"
//                           name="trailer_url"
...
//                               Selected: {trailerFiles[index].name}
//                             </p>
//                           )}
//                         </div>
//                       )}
...
interface FormState {
  ...
  tags: string;
  trailer_url: string;
  trailerFile?: File | null; // Add this line with optional and null type
}
